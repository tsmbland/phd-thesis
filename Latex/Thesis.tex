...
\begin{align}
\mu_{c,1} &= \log\left(\frac{\phi_{c,1}}{1 - \phi_{c,1} - \phi_{c,2}}\right) - w_{c,1}\\
\mu_{c,2} &= \log\left(\frac{\phi_{c,2}}{2 - \phi_{c,2}}\right) + 2\log\left(\frac{\phi_{c,2}}{1 - \phi_{c,1} - \phi_{c,2}}\right) - w_{c,2}\\
\mu_{m,1} &= \log\left(\frac{\phi_{m,1}}{1 - \phi_{m,1} - \phi_{m,2}}\right) - w_{m,1}\\
\mu_{m,2} &= \log\left(\frac{\phi_{m,2}}{2 - \phi_{m,2}}\right) + 2\log\left(\frac{\phi_{m,2}}{1 - \phi_{m,1} - \phi_{m,2}}\right) - w_{m,2}
\end{align}
\end{comment}
...
\begin{figure}[!h]
\includegraphics[scale=0.85]{thermodynamic_model_feedback}
\setlength{\abovecaptionskip}{20pt}
\centering
\mycaption{Title}{Caption}
\end{figure}
