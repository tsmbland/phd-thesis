...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\section{Uncovering a PAR-2 positive feedback circuit}
...
\subsubsection{The PAR-2 polarity pathway}
...
\subsubsection{Self-recruitment}
...
\subsubsection{Substrate-kinase interaction}
...
\subsection{Quantitative characterisation of PAR-2 mutant alleles}
